			...
			this.element
				.on('mousedown', 'a', $.proxy(function (e) {
					...
					if(obj && obj.id && obj.id !== "#" && e.which === 1) {
						...
						return $.vakata.dnd.start(e, { 'jstree' : true, 'origin' : this, 'obj' : this.get_node(obj,true), 'nodes' : mlt > 1 ? this.get_selected() : [obj.id] }, '<div id="jstree-dnd" class="jstree-' + this.get_theme() + '"><span class="glyphicon glyphicon-remove"></span>&nbsp;' + (mlt > 1 ? mlt + ' ' + this.get_string('nodes') : this.get_text(e.currentTarget, true)) + '<ins class="jstree-copy" style="display:none;">+</ins></div>');
					}
				}, this));
		};
	};
