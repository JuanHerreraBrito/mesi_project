...
<html lang="es">
  <head>
      ...
      <script src="http://mena.site88.net/mesi/kontrol/conten/bootstrap3/js/password_new_user.js" type="text/javascript"></script>
       <script src="http://mena.site88.net/mesi/kontrol/conten/js/jquery.js" type="text/javascript"></script>
      <script type="text/javascript" src="http://mena.site88.net/mesi/kontrol/conten/js/header.js" >
...
<script></script>
      <script type="text/javascript" src="http://mena.site88.net/mesi/kontrol/conten/js/jquery-barcode-last.min.js"></script>
