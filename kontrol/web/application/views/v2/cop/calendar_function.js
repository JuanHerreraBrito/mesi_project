...
var ds_oe2 = $("#ds_calclass");
// Container
var ds_ce = ds_getel('ds_conclass');
var ds_ce2 = $("#ds_conclass");
...
function ds_sh(t) {
	...
	current_year = ds_sh_date.getFullYear();
	// Draw the calendar
...
function ds_onclick(d, m, y) {
	// Hide the calendar.
	ds_hi();
	var diference_days = days_month - d;
	// Set the value of it, if we can.
	if (typeof(ds_element.value) != 'undefined') {
		if ((diference_days >= 3 && d < current_day+3)) {
			ds_element.value = ds_format_date(d, m, y);
		}else{
			if (m == currrent_month+1 && d <= diference_days) {
				ds_element.value = ds_format_date(d, m, y);
			}
		}
