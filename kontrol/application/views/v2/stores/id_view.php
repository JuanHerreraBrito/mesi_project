    ...
    <div class="col-lg-12 col-md-12 col-sm-12 ">
        <div class="item-container">
            <div class="items">
                ...
                <h4><?=$this->lang->line('v3_layout_items_showing_items_drag_n_drop')?> <div id="edit-menu" style="display:none" class="pull-right"><?=$this->lang->line('v3_layout_items_edit')?>:&nbsp;<select class="edit-attribute"><option value="precio"><?=$this->lang->line('v3_layout_items_price')?></option><option value="live"><?=$this->lang->line('v3_layout_items_live')?></option><option value="inventory">Inventario</option></select></div></h4>
                ...
                <ul style="display:none;padding:0;" id="inventory"></ul>
                <div class="itemBox">
